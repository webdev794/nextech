...
MD,
    ...
    private function seedProducts(): void
    {
        ...
        $products = [
            ['Apple iPhone 15 Pro', 'apple-iphone-15-pro', 'Apple\'s titanium-body flagship with the A17 Pro chip, a 48MP main camera, and USB-C — built for all-day performance in the pocket.', 'GDP-PROD-001', 99900, null, 100, '/img/products/prod-apple-iphone-15-pro.jpg', 'mobiles-smartphones'],
            ['Samsung Galaxy S24', 'samsung-galaxy-s24', 'A compact Android flagship with a bright Dynamic AMOLED display, Snapdragon power, and Galaxy AI features built in.', 'GDP-PROD-002', 79900, null, 99, '/img/products/prod-samsung-galaxy-s24.jpg', 'mobiles-smartphones'],
            ['Google Pixel 8', 'google-pixel-8', 'Google\'s pure-Android phone with the Tensor G3 chip and a camera tuned for standout low-light and portrait shots.', 'GDP-PROD-007', 69900, 74900, 100, '/img/products/prod-google-pixel-8.jpg', 'mobiles-smartphones'],
            ['OnePlus 12', 'oneplus-12', 'A fast, fluid flagship with Hasselblad-tuned cameras and 100W charging that tops up the battery in minutes.', 'GDP-PROD-008', 73900, null, 100, '/img/products/prod-oneplus-12.jpg', 'mobiles-smartphones'],
            ['Xiaomi 14', 'xiaomi-14', 'A pocketable flagship with Leica optics and flagship-tier Snapdragon performance at a sharp price.', 'GDP-PROD-009', 64900, null, 100, '/img/products/prod-xiaomi-14.jpg', 'mobiles-smartphones'],
            ['Apple MacBook Air M3', 'apple-macbook-air-m3', 'Apple\'s fanless, all-day laptop — the M3 chip handles everyday work and creative apps without breaking a sweat.', 'GDP-PROD-003', 109900, null, 80, '/img/products/prod-apple-macbook-air-m3.jpg', 'laptops-computers'],
            ['Dell XPS 13', 'dell-xps-13', 'A compact ultrabook with an edge-to-edge InfinityEdge display, built for work on the go.', 'GDP-PROD-004', 99900, null, 100, '/img/products/prod-dell-xps-13.png', 'laptops-computers'],
            ['HP Spectre x360', 'hp-spectre-x360', 'A convertible 2-in-1 with a gem-cut design that folds flat into tablet mode for sketching, notes, or streaming.', 'GDP-PROD-010', 129900, null, 91, '/img/products/prod-hp-spectre-x360.png', 'laptops-computers'],
            ['Lenovo ThinkPad X1 Carbon', 'lenovo-thinkpad-x1-carbon', 'The business standard: a carbon-fibre chassis, legendary keyboard, and MIL-SPEC durability.', 'GDP-PROD-011', 159900, null, 89, '/img/products/prod-lenovo-thinkpad-x1-carbon.jpg', 'laptops-computers'],
            ['Asus ROG Zephyrus G14', 'asus-rog-zephyrus-g14', 'A compact gaming laptop that punches well above its size, with enough GPU power for the latest titles.', 'GDP-PROD-012', 179900, null, 98, '/img/products/prod-asus-rog-zephyrus-g14.jpg', 'laptops-computers'],
            ['Sony WH-1000XM5', 'sony-wh-1000xm5', 'Industry-leading noise cancellation and all-day comfort, tuned for travel and focus.', 'GDP-PROD-005', 34900, null, 99, '/img/products/prod-sony-wh-1000xm5.jpg', 'audio-headphones'],
            ['Apple AirPods Pro 2', 'apple-airpods-pro-2', 'Adaptive noise cancellation, Transparency mode, and spatial audio in Apple\'s smallest true wireless earbuds.', 'GDP-PROD-006', 24900, null, 99, '/img/products/prod-apple-airpods-pro-2.jpg', 'audio-headphones'],
            ['Bose QuietComfort Ultra', 'bose-quietcomfort-ultra', 'Bose\'s quietest headphones yet, with immersive spatial audio and plush all-day comfort.', 'GDP-PROD-013', 42900, null, 100, '/img/products/prod-bose-quietcomfort-ultra.jpg', 'audio-headphones'],
            ['JBL Flip 6 Speaker', 'jbl-flip-6-speaker', 'A rugged, waterproof Bluetooth speaker with punchy JBL sound for the beach, the shower, or the backyard.', 'GDP-PROD-014', 12900, null, 99, '/img/products/prod-jbl-flip-6-speaker.jpg', 'audio-headphones'],
            ['Sennheiser Momentum 4', 'sennheiser-momentum-4', 'Audiophile-tuned sound with up to 60 hours of battery life on a single charge.', 'GDP-PROD-015', 34900, null, 99, '/img/products/prod-sennheiser-momentum-4.jpg', 'audio-headphones'],
            ['Tempered Glass Screen Protector', 'tempered-glass-screen-protector', '9H hardness, an oleophobic coating, and edge-to-edge clarity that keeps your screen scratch-free.', 'GDP-PROD-016', 999, null, 100, '/img/products/prod-tempered-glass-screen-protector.jpg', 'mobile-accessories'],
            ['Silicone Phone Case', 'silicone-phone-case', 'A soft-touch silicone case with a microfibre lining that protects without adding bulk.', 'GDP-PROD-017', 1499, null, 99, '/img/products/prod-silicone-phone-case.jpg', 'mobile-accessories'],
            ['MagSafe Wireless Charger', 'magsafe-wireless-charger', 'Snap-on magnetic charging for a clean, cable-free charge every time you set your phone down.', 'GDP-PROD-018', 3999, null, 100, '/img/products/prod-magsafe-wireless-charger.jpg', 'mobile-accessories'],
            ['Apple Watch Series 9', 'apple-watch-series-9', 'Apple\'s smartwatch with the new double-tap gesture, a brighter always-on display, and deep health tracking.', 'GDP-PROD-019', 39900, null, 100, '/img/products/prod-apple-watch-series-9.jpg', 'smart-watches-wearables'],
            ['Samsung Galaxy Watch 6', 'samsung-galaxy-watch-6', 'A sleek Wear OS smartwatch with advanced sleep coaching and body composition tracking.', 'GDP-PROD-020', 32900, null, 100, '/img/products/prod-samsung-galaxy-watch-6.jpg', 'smart-watches-wearables'],
            ['Fitbit Charge 6', 'fitbit-charge-6', 'A slim fitness tracker with built-in GPS, heart-rate tracking, and up to a week of battery life.', 'GDP-PROD-021', 15900, null, 100, '/img/products/prod-fitbit-charge-6.jpg', 'smart-watches-wearables'],
            ['Canon EOS R50', 'canon-eos-r50', 'An entry-level mirrorless camera with fast autofocus, ideal for stepping up from a phone camera.', 'GDP-PROD-022', 79900, null, 100, '/img/products/prod-canon-eos-r50.jpg', 'cameras-photography'],
            ['Sony Alpha ZV-E10', 'sony-alpha-zv-e10', 'A vlogging-focused mirrorless camera with a fully articulating screen and background-defocus mode.', 'GDP-PROD-023', 69900, null, 100, '/img/products/prod-sony-alpha-zv-e10.jpg', 'cameras-photography'],
            ['GoPro Hero 12', 'gopro-hero-12', 'Rugged, waterproof, and stabilized — built to capture action from anywhere.', 'GDP-PROD-024', 39900, null, 100, '/img/products/prod-gopro-hero-12.jpg', 'cameras-photography'],
            ['Samsung 55" QLED TV', 'samsung-55-qled-tv', 'Quantum Dot colour and a wide viewing angle bring movies and sport to life in a 55-inch frame.', 'GDP-PROD-025', 89900, null, 100, '/img/products/prod-samsung-55-qled-tv.jpg', 'televisions'],
            ['LG 65" OLED TV', 'lg-65-oled-tv', 'Self-lit OLED pixels deliver perfect blacks and infinite contrast on a 65-inch canvas.', 'GDP-PROD-026', 179900, null, 100, '/img/products/prod-lg-65-oled-tv.jpg', 'televisions'],
            ['Sony 43" Bravia TV', 'sony-43-bravia-tv', 'Sony\'s processing engine sharpens detail and motion for a crisp, cinematic picture.', 'GDP-PROD-027', 54900, null, 100, '/img/products/prod-sony-43-bravia-tv.jpg', 'televisions'],
            ['Sony PlayStation 5', 'sony-playstation-5', 'Lightning-fast SSD loading, stunning visuals, and the DualSense controller\'s haptic feedback.', 'GDP-PROD-028', 49900, null, 100, '/img/products/prod-sony-playstation-5.jpg', 'gaming-consoles-accessories'],
            ['Microsoft Xbox Series X', 'microsoft-xbox-series-x', 'Microsoft\'s most powerful console, built for 4K gaming at up to 120fps.', 'GDP-PROD-029', 49900, null, 100, '/img/products/prod-microsoft-xbox-series-x.jpg', 'gaming-consoles-accessories'],
            ['Nintendo Switch OLED', 'nintendo-switch-oled', 'A vivid 7-inch OLED screen makes handheld play pop, and it still docks to the TV in seconds.', 'GDP-PROD-030', 34900, null, 100, '/img/products/prod-nintendo-switch-oled.jpg', 'gaming-consoles-accessories'],
            ['Dyson V15 Vacuum Cleaner', 'dyson-v15-vacuum-cleaner', 'A laser reveals hidden dust while a cordless motor delivers powerful, whole-home suction.', 'GDP-PROD-031', 74900, null, 100, '/img/products/prod-dyson-v15-vacuum-cleaner.jpg', 'home-appliances'],
            ['Philips Air Fryer XXL', 'philips-air-fryer-xxl', 'Rapid Air technology cooks crispy, low-oil favourites fast enough for a weeknight dinner.', 'GDP-PROD-032', 19900, null, 100, '/img/products/prod-philips-air-fryer-xxl.jpg', 'home-appliances'],
            ['LG 8kg Front Load Washing Machine', 'lg-8kg-front-load-washing-machine', 'Steam-cleaning and a quiet direct-drive motor make laundry day easier.', 'GDP-PROD-033', 54900, null, 100, '/img/products/prod-lg-8kg-front-load-washing-machine.jpg', 'home-appliances'],
            ['Logitech MX Master 3S Mouse', 'logitech-mx-master-3s-mouse', 'A precision mouse with silent clicks and an ultra-fast scroll wheel, built for all-day productivity.', 'GDP-PROD-034', 9900, null, 100, '/img/products/prod-logitech-mx-master-3s-mouse.jpg', 'computer-accessories'],
            ['Keychron K2 Mechanical Keyboard', 'keychron-k2-mechanical-keyboard', 'Hot-swappable mechanical switches and Bluetooth multi-device pairing in a compact 75% layout.', 'GDP-PROD-035', 8900, null, 100, '/img/products/prod-keychron-k2-mechanical-keyboard.jpg', 'computer-accessories'],
            ['Dell 27" 4K Monitor', 'dell-27-4k-monitor', 'Sharp 4K clarity and accurate colour on a 27-inch panel built for work and creative editing.', 'GDP-PROD-036', 39900, null, 100, '/img/products/prod-dell-27-4k-monitor.jpg', 'computer-accessories'],
            ['Anker 20000mAh Power Bank', 'anker-20000mah-power-bank', 'Enough capacity for multiple full phone charges, with fast pass-through charging.', 'GDP-PROD-037', 4999, null, 100, '/img/products/prod-anker-20000mah-power-bank.jpg', 'power-banks-chargers'],
            ['Apple 20W USB-C Fast Charger', 'apple-20w-usb-c-fast-charger', 'Apple\'s compact charger tops up an iPhone to 50% in about 30 minutes.', 'GDP-PROD-038', 1999, null, 100, '/img/products/prod-apple-20w-usb-c-fast-charger.jpg', 'power-banks-chargers'],
            ['Belkin 3-in-1 Wireless Charging Stand', 'belkin-3-in-1-wireless-charging-stand', 'Charge your phone, watch, and earbuds together from a single stand.', 'GDP-PROD-039', 9999, null, 100, '/img/products/prod-belkin-3-in-1-wireless-charging-stand.jpg', 'power-banks-chargers'],
            ['SanDisk 1TB Portable SSD', 'sandisk-1tb-portable-ssd', 'Pocket-sized storage with fast transfer speeds, built to survive drops and bumps on the go.', 'GDP-PROD-040', 8999, null, 100, '/img/products/prod-sandisk-1tb-portable-ssd.jpg', 'storage-devices'],
            ['Samsung 256GB microSD Card', 'samsung-256gb-microsd-card', 'High-speed storage for phones, cameras, and handheld consoles.', 'GDP-PROD-041', 2999, null, 100, '/img/products/prod-samsung-256gb-microsd-card.jpg', 'storage-devices'],
            ['WD 2TB External Hard Drive', 'wd-2tb-external-hard-drive', 'Reliable backup storage with plug-and-play simplicity for photos, videos, and files.', 'GDP-PROD-042', 6999, null, 100, '/img/products/prod-wd-2tb-external-hard-drive.jpg', 'storage-devices'],
            ['TP-Link Archer WiFi 6 Router', 'tp-link-archer-wifi-6-router', 'Faster, more reliable Wi-Fi for a house full of devices with WiFi 6 speeds.', 'GDP-PROD-043', 12900, null, 100, '/img/products/prod-tp-link-archer-wifi-6-router.jpg', 'networking-devices'],
            ['Netgear Orbi Mesh WiFi System', 'netgear-orbi-mesh-wifi-system', 'Whole-home mesh coverage that eliminates dead zones without losing speed.', 'GDP-PROD-044', 22900, null, 100, '/img/products/prod-netgear-orbi-mesh-wifi-system.jpg', 'networking-devices'],
            ['TP-Link 8-Port Gigabit Switch', 'tp-link-8-port-gigabit-switch', 'Expand your wired network with eight reliable gigabit ports.', 'GDP-PROD-045', 3999, null, 100, '/img/products/prod-tp-link-8-port-gigabit-switch.jpg', 'networking-devices'],
            ['Philips Hair Dryer', 'philips-hair-dryer', 'Fast-drying airflow with a cooling shot to lock in your style.', 'GDP-PROD-046', 2999, null, 100, '/img/products/prod-philips-hair-dryer.jpg', 'personal-care-electronics'],
            ['Oral-B Electric Toothbrush', 'oral-b-electric-toothbrush', 'A pressure sensor and timer help you brush the dentist-recommended way, every time.', 'GDP-PROD-047', 4999, null, 100, '/img/products/prod-oral-b-electric-toothbrush.jpg', 'personal-care-electronics'],
            ['Panasonic Beard Trimmer', 'panasonic-beard-trimmer', 'Precision blades and multiple length settings for a clean, consistent trim.', 'GDP-PROD-048', 3499, null, 100, '/img/products/prod-panasonic-beard-trimmer.jpg', 'personal-care-electronics'],
            ['Motorola Video Baby Monitor', 'motorola-video-baby-monitor', 'See and hear your baby clearly with night vision and two-way audio.', 'GDP-PROD-049', 8999, null, 100, '/img/products/prod-motorola-video-baby-monitor.jpg', 'kids-and-baby-tech'],
            ['Amazon Fire Kids Tablet', 'amazon-fire-kids-tablet', 'A durable, parent-controlled tablet built for young explorers, with a kid-proof case included.', 'GDP-PROD-050', 9999, null, 100, '/img/products/prod-amazon-fire-kids-tablet.jpg', 'kids-and-baby-tech'],
            ['LeapFrog Learning Tablet', 'leapfrog-learning-tablet', 'A screen-time companion designed to teach letters, numbers, and problem-solving through play.', 'GDP-PROD-051', 5999, null, 100, '/img/products/prod-leapfrog-learning-tablet.jpg', 'kids-and-baby-tech'],
            ['HP LaserJet Printer', 'hp-laserjet-printer', 'Crisp, fast black-and-white printing built for the home office.', 'GDP-PROD-052', 17900, null, 100, '/img/products/prod-hp-laserjet-printer.jpg', 'office-electronics'],
            ['Epson Portable Projector', 'epson-portable-projector', 'A compact projector that turns any wall into a big screen for movies or presentations.', 'GDP-PROD-053', 39900, null, 100, '/img/products/prod-epson-portable-projector.jpg', 'office-electronics'],
            ['Logitech Webcam C920', 'logitech-webcam-c920', 'Full HD 1080p video and clear audio, built for sharp video calls and streaming.', 'GDP-PROD-054', 6999, 7999, 100, '/img/products/prod-logitech-webcam-c920.jpg', 'office-electronics'],

            ['Amazon Echo Dot (5th Gen)', 'amazon-echo-dot-5th-gen', 'A compact smart speaker with Alexa built in, for music, routines, and controlling the rest of your smart home.', 'GDP-PROD-055', 4999, null, 100, '/img/products/cat-smart-home.jpg', 'smart-home'],
            ['Philips Hue Smart Bulb Starter Kit', 'philips-hue-smart-bulb-starter-kit', 'Millions of colours and app-controlled scenes, with a bridge included to get your smart lighting started.', 'GDP-PROD-056', 6999, null, 100, '/img/products/cat-smart-home.jpg', 'smart-home'],
            ['TP-Link Kasa Smart Plug', 'tp-link-kasa-smart-plug', 'Turn any outlet smart — schedule, voice-control, or remotely switch appliances from your phone.', 'GDP-PROD-057', 1999, null, 100, '/img/products/cat-smart-home.jpg', 'smart-home'],
            ['Ring Video Doorbell', 'ring-video-doorbell', 'See, hear, and speak to visitors from anywhere, with motion alerts sent straight to your phone.', 'GDP-PROD-058', 9999, null, 100, '/img/products/cat-smart-home.jpg', 'smart-home'],
            ['Eufy RoboVac 11S Robot Vacuum', 'eufy-robovac-11s-robot-vacuum', 'A slim robot vacuum that slides under furniture and keeps floors clean on a schedule you set.', 'GDP-PROD-059', 19900, null, 100, '/img/products/cat-smart-home.jpg', 'smart-home'],

            ['Garmin Vivosmart 5 Fitness Band', 'garmin-vivosmart-5-fitness-band', 'A slim fitness band with heart-rate tracking, sleep scores, and up to seven days of battery life.', 'GDP-PROD-060', 12900, null, 100, '/img/products/cat-health-and-fitness-tech.jpg', 'health-and-fitness-tech'],
            ['Withings Body+ Smart Scale', 'withings-body-plus-smart-scale', 'Weight, body fat, and muscle mass synced automatically to your phone every time you step on.', 'GDP-PROD-061', 9900, null, 100, '/img/products/cat-health-and-fitness-tech.jpg', 'health-and-fitness-tech'],
            ['Omron Digital Blood Pressure Monitor', 'omron-digital-blood-pressure-monitor', 'Clinically validated, one-button readings you can track at home between doctor visits.', 'GDP-PROD-062', 4999, null, 100, '/img/products/cat-health-and-fitness-tech.jpg', 'health-and-fitness-tech'],
            ['Wellue Pulse Oximeter', 'wellue-pulse-oximeter', 'A fingertip sensor that reads blood oxygen and pulse rate in seconds, with an easy-read display.', 'GDP-PROD-063', 2999, null, 100, '/img/products/cat-health-and-fitness-tech.jpg', 'health-and-fitness-tech'],
            ['Xiaomi Smart Skipping Rope', 'xiaomi-smart-skipping-rope', 'Counts jumps, calories, and workout time automatically, and syncs your session to a fitness app.', 'GDP-PROD-064', 1999, null, 100, '/img/products/cat-health-and-fitness-tech.jpg', 'health-and-fitness-tech'],

            ['Apple iPhone 15 Pro Max', 'apple-iphone-15-pro-max', 'The largest, most capable iPhone — a titanium build, a 5x telephoto lens, and the A17 Pro chip.', 'GDP-PROD-065', 119900, null, 100, '/img/products/cat-premium-and-flagship.jpg', 'premium-and-flagship'],
            ['Samsung Galaxy Z Fold 6', 'samsung-galaxy-z-fold-6', 'A phone that unfolds into a tablet, with a smoother hinge and multitasking built for a bigger screen.', 'GDP-PROD-066', 179900, null, 100, '/img/products/cat-premium-and-flagship.jpg', 'premium-and-flagship'],
            ['Sony Xperia 1 VI', 'sony-xperia-1-vi', 'A creator-focused flagship with a versatile zoom lens system and pro-grade video controls.', 'GDP-PROD-067', 139900, null, 100, '/img/products/cat-premium-and-flagship.jpg', 'premium-and-flagship'],
            ['Asus ROG Phone 8', 'asus-rog-phone-8', 'A gaming flagship with a 165Hz display, AirTrigger controls, and cooling built for long sessions.', 'GDP-PROD-068', 109900, null, 100, '/img/products/cat-premium-and-flagship.jpg', 'premium-and-flagship'],
            ['Dell XPS 15 Plus', 'dell-xps-15-plus', 'A premium creator laptop with an edge-to-edge InfinityEdge display and serious rendering power.', 'GDP-PROD-069', 189900, null, 100, '/img/products/cat-premium-and-flagship.jpg', 'premium-and-flagship'],

            ['Garmin DriveSmart 55 GPS Navigator', 'garmin-drivesmart-55-gps-navigator', 'Voice-activated turn-by-turn navigation with live traffic, built for the dashboard.', 'GDP-PROD-070', 19900, null, 100, '/img/products/cat-car-electronics.jpg', 'car-electronics'],
            ['Pioneer Bluetooth Car Stereo Receiver', 'pioneer-bluetooth-car-stereo-receiver', 'A touchscreen head unit upgrade with Bluetooth calling and streaming built in for any dashboard.', 'GDP-PROD-071', 8999, null, 100, '/img/products/cat-car-electronics.jpg', 'car-electronics'],
            ['iOttie Car Dashboard Phone Mount', 'iottie-car-dashboard-phone-mount', 'A one-hand, one-touch mount that holds your phone steady on the dash or windshield for hands-free navigation.', 'GDP-PROD-072', 2499, null, 100, '/img/products/cat-car-electronics.jpg', 'car-electronics'],
            ['Car Vent Air Purifier & Freshener', 'car-vent-air-purifier-freshener', 'Clips onto any air vent to filter odours and keep the cabin smelling fresh on every drive.', 'GDP-PROD-073', 1499, null, 100, '/img/products/cat-car-electronics.jpg', 'car-electronics'],
            ['Pioneer Digital Car Clock Gauge', 'pioneer-digital-car-clock-gauge', 'A dash-mounted digital clock and gauge that drops into any spare vent or console slot.', 'GDP-PROD-074', 2999, null, 100, '/img/products/cat-car-electronics.jpg', 'car-electronics'],
        ];
    ...
    private function seedProductVariants(): void
    {
        ...
        $variants = [
            ...
            ['GDP-PROD-005', 'Platinum Silver', 'GDP-PROD-005-5KG', 36900, null, 15, '/img/products/variant-sony-wh-1000xm5-platinum-silver.jpg', 2],
            ...
            ['GDP-PROD-017', 'Ocean Blue', 'GDP-PROD-017-V1', 1499, null, 40, '/img/products/variant-silicone-phone-case-ocean-blue.jpg', 1],
            ['GDP-PROD-017', 'Blossom Pink', 'GDP-PROD-017-V2', 1499, null, 40, '/img/products/variant-silicone-phone-case-blossom-pink.jpg', 2],
            ['GDP-PROD-019', '45mm', 'GDP-PROD-019-V1', 42900, null, 40, null, 1],
            ['GDP-PROD-021', 'Coral', 'GDP-PROD-021-V1', 15900, null, 40, null, 1],
            ['GDP-PROD-028', 'Digital Edition', 'GDP-PROD-028-V1', 44900, null, 40, null, 1],
            ['GDP-PROD-030', 'Neon Red / Neon Blue', 'GDP-PROD-030-V1', 34900, null, 40, null, 1],
            ['GDP-PROD-034', 'Pale Grey', 'GDP-PROD-034-V1', 9900, null, 40, '/img/products/variant-logitech-mx-master-3s-mouse-pale-grey.jpg', 1],
        ];
